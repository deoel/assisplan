...
<html>
    ...
    <div class="container">
	    ...
	    <div class="form-group">
            <label for="varchar">Nomcomplet <?php echo form_error('nomcomplet') ?></label>
            <input type="text" class="form-control" name="nomcomplet" id="nomcomplet" placeholder="Nomcomplet" value="<?php echo $nomcomplet; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
            <label for="int">Annee Debut <?php echo form_error('annee_debut') ?></label>
            <input type="text" class="form-control" name="annee_debut" id="annee_debut" placeholder="Annee Debut" value="<?php echo $annee_debut; ?>" />
        </div>
