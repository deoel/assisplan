...
<html>
    ...
    <div class="container">
        ...
        <h2 style="margin-top:0px">Classe List</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('classe/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('classe/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('classe'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
            ...
            foreach ($classe_data as $classe)
            {
                ?>
                <tr>
			<td width="80px"><?php echo ++$start ?></td>
			<td><?php echo $classe->nom ?></td>
			<td><?php echo $classe->abbreviation ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('classe/read/'.$classe->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('classe/update/'.$classe->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('classe/delete/'.$classe->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
