...
<html>
    ...
    <div class="container">
	    ...
	    <div class="form-group">
            <label for="varchar">Intitule <?php echo form_error('intitule') ?></label>
            <input type="text" class="form-control" name="intitule" id="intitule" placeholder="Intitule" value="<?php echo $intitule; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">Abbreviation <?php echo form_error('abbreviation') ?></label>
            <input type="text" class="form-control" name="abbreviation" id="abbreviation" placeholder="Abbreviation" value="<?php echo $abbreviation; ?>" />
        </div>
