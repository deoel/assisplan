...
<html>
    ...
    <div class="container">
		...
		<th>Action</th>
			...
			<td><?php echo $cours->intitule ?></td>
			<td><?php echo $cours->abbreviation ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('cours/read/'.$cours->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('cours/update/'.$cours->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('cours/delete/'.$cours->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
